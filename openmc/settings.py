...
_RES_SCAT_METHODS = ['dbrc', 'rvs', 'mars']
...
class Settings:
    ...
    resonance_scattering : dict
        ...
        'nuclides' (list). The 'method' can be set to 'dbrc' (Doppler
        broadening rejection correction), 'rvs' (relative velocity sampling),
        or 'mars'. The 'mars' option requires that windowed multipole data is
        present for whatever nuclides may undergo resonance scattering. If not
        ...
        The 'nuclides' list indicates what nuclides the method should be
        applied to. In its absence, the method will be applied to all nuclides
