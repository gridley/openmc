...
void allocate_soa_data()
{
  ...
  cudaMemcpyToSymbol(soa::gpu::n_nuclides, &n_nuclides, sizeof(int));
  cudaMemcpyToSymbol(soa::gpu::n_elements, &n_elements, sizeof(int));
  cudaMemcpyToSymbol(soa::gpu::n_coord_levels, &n_coord_levels, sizeof(int));
  cudaMemcpyToSymbol(soa::gpu::n_tally_derivs, &n_tally_derivs, sizeof(int));
  cudaMemcpyToSymbol(soa::gpu::n_tally_filters, &n_tally_filters, sizeof(int));

  void* tmp;
  tmp = neutron_xs.data();
  cudaMemcpyToSymbol(soa::gpu::neutron_xs, &tmp, sizeof(void*));
  tmp = photon_xs.data();
  cudaMemcpyToSymbol(soa::gpu::photon_xs, &tmp, sizeof(void*));
  tmp = macro_xs.data();
  cudaMemcpyToSymbol(soa::gpu::macro_xs, &tmp, sizeof(void*));
  tmp = id.data();
  cudaMemcpyToSymbol(soa::gpu::id, &tmp, sizeof(void*));
  tmp = type.data();
  cudaMemcpyToSymbol(soa::gpu::type, &tmp, sizeof(void*));
  tmp = n_coord.data();
  cudaMemcpyToSymbol(soa::gpu::n_coord, &tmp, sizeof(void*));
  tmp = coord.data();
  cudaMemcpyToSymbol(soa::gpu::cell_instance, &tmp, sizeof(void*));
  tmp = coord.data();
  cudaMemcpyToSymbol(soa::gpu::coord, &tmp, sizeof(void*));
  tmp = n_coord_last.data();
  cudaMemcpyToSymbol(soa::gpu::n_coord_last, &tmp, sizeof(void*));
  tmp = cell_last.data();
  cudaMemcpyToSymbol(soa::gpu::cell_last, &tmp, sizeof(void*));
  tmp = E.data();
  cudaMemcpyToSymbol(soa::gpu::E, &tmp, sizeof(void*));
  tmp = E_last.data();
  cudaMemcpyToSymbol(soa::gpu::E_last, &tmp, sizeof(void*));
  tmp = g.data();
  cudaMemcpyToSymbol(soa::gpu::g, &tmp, sizeof(void*));
  tmp = g_last.data();
  cudaMemcpyToSymbol(soa::gpu::g_last, &tmp, sizeof(void*));
  tmp = wgt.data();
  cudaMemcpyToSymbol(soa::gpu::wgt, &tmp, sizeof(void*));
  tmp = mu.data();
  cudaMemcpyToSymbol(soa::gpu::mu, &tmp, sizeof(void*));
  tmp = alive.data();
  cudaMemcpyToSymbol(soa::gpu::alive, &tmp, sizeof(void*));
  tmp = r_last_current.data();
  cudaMemcpyToSymbol(soa::gpu::r_last_current, &tmp, sizeof(void*));
  tmp = u_last.data();
  cudaMemcpyToSymbol(soa::gpu::r_last, &tmp, sizeof(void*));
  tmp = u_last.data();
  cudaMemcpyToSymbol(soa::gpu::u_last, &tmp, sizeof(void*));
  tmp = wgt_last.data();
  cudaMemcpyToSymbol(soa::gpu::wgt_last, &tmp, sizeof(void*));
  tmp = wgt_absorb.data();
  cudaMemcpyToSymbol(soa::gpu::wgt_absorb, &tmp, sizeof(void*));
  tmp = fission.data();
  cudaMemcpyToSymbol(soa::gpu::fission, &tmp, sizeof(void*));
  tmp = event.data();
  cudaMemcpyToSymbol(soa::gpu::event, &tmp, sizeof(void*));
  tmp = event_nuclide.data();
  cudaMemcpyToSymbol(soa::gpu::event_nuclide, &tmp, sizeof(void*));
  tmp = event_mt.data();
  cudaMemcpyToSymbol(soa::gpu::event_mt, &tmp, sizeof(void*));
  tmp = delayed_group.data();
  cudaMemcpyToSymbol(soa::gpu::delayed_group, &tmp, sizeof(void*));
  tmp = n_bank.data();
  cudaMemcpyToSymbol(soa::gpu::n_bank, &tmp, sizeof(void*));
  tmp = n_bank_second.data();
  cudaMemcpyToSymbol(soa::gpu::n_bank_second, &tmp, sizeof(void*));
  tmp = wgt_bank.data();
  cudaMemcpyToSymbol(soa::gpu::wgt_bank, &tmp, sizeof(void*));
  tmp = n_delayed_bank.data();
  cudaMemcpyToSymbol(soa::gpu::n_delayed_bank, &tmp, sizeof(void*));
  tmp = surface.data();
  cudaMemcpyToSymbol(soa::gpu::surface, &tmp, sizeof(void*));
  tmp = cell_born.data();
  cudaMemcpyToSymbol(soa::gpu::cell_born, &tmp, sizeof(void*));
  tmp = material.data();
  cudaMemcpyToSymbol(soa::gpu::material, &tmp, sizeof(void*));
  tmp = material_last.data();
  cudaMemcpyToSymbol(soa::gpu::material_last, &tmp, sizeof(void*));
  tmp = boundary.data();
  cudaMemcpyToSymbol(soa::gpu::boundary, &tmp, sizeof(void*));
  tmp = sqrtkT.data();
  cudaMemcpyToSymbol(soa::gpu::sqrtkT, &tmp, sizeof(void*));
  tmp = sqrtkT_last.data();
  cudaMemcpyToSymbol(soa::gpu::sqrtkT_last, &tmp, sizeof(void*));
  tmp = n_collision.data();
  cudaMemcpyToSymbol(soa::gpu::n_collision, &tmp, sizeof(void*));
  tmp = write_track.data();
  cudaMemcpyToSymbol(soa::gpu::write_track, &tmp, sizeof(void*));
  tmp = seeds.data();
  cudaMemcpyToSymbol(soa::gpu::seeds, &tmp, sizeof(void*));
  tmp = stream.data();
  cudaMemcpyToSymbol(soa::gpu::stream, &tmp, sizeof(void*));
  tmp = secondary_bank_current_indx.data();
  cudaMemcpyToSymbol(soa::gpu::secondary_bank_current_indx, &tmp, sizeof(void*));
  tmp = secondary_bank.data();
  cudaMemcpyToSymbol(soa::gpu::secondary_bank, &tmp, sizeof(void*));
  tmp = current_work.data();
  cudaMemcpyToSymbol(soa::gpu::current_work, &tmp, sizeof(void*));
  tmp = flux_derivs.data();
  cudaMemcpyToSymbol(soa::gpu::flux_derivs, &tmp, sizeof(void*));
  tmp = filter_matches.data();
  cudaMemcpyToSymbol(soa::gpu::filter_matches, &tmp, sizeof(void*));
  tmp = nu_bank_current_indx.data();
  cudaMemcpyToSymbol(soa::gpu::nu_bank_current_indx, &tmp, sizeof(void*));
  tmp = nu_bank.data();
  cudaMemcpyToSymbol(soa::gpu::nu_bank, &tmp, sizeof(void*));
  tmp = keff_tally_absorption.data();
  cudaMemcpyToSymbol(soa::gpu::keff_tally_absorption, &tmp, sizeof(void*));
  tmp = keff_tally_collision.data();
  cudaMemcpyToSymbol(soa::gpu::keff_tally_collision, &tmp, sizeof(void*));
  tmp = keff_tally_tracklength.data();
  cudaMemcpyToSymbol(soa::gpu::keff_tally_tracklength, &tmp, sizeof(void*));
  ...
  tmp = n_progeny.data();
  cudaMemcpyToSymbol(soa::gpu::n_progeny, &tmp, sizeof(void*));
  tmp = neutron_xs.data();
  cudaMemcpyToSymbol(soa::gpu::neutron_xs, &tmp, sizeof(void*));
  tmp = photon_xs.data();
  cudaMemcpyToSymbol(soa::gpu::photon_xs, &tmp, sizeof(void*));
...
vector<xsfloat> sqrtkT;
vector<xsfloat> sqrtkT_last;
...
__constant__ xsfloat* E;
__constant__ xsfloat* E_last;
__constant__ int* g;
__constant__ int* g_last;
__constant__ double* wgt;
__constant__ xsfloat* mu;
...
__constant__ xsfloat* sqrtkT;
__constant__ xsfloat* sqrtkT_last;
